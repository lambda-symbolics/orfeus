...
(defun test-preview-neighborhood-bounds ()
  (check (equal '(0 1 2)
                (orfeus/gui::preview-neighborhood-indices 100 0 2))
         "Preview neighborhood crossed the project start")
  (check (equal '(48 49 50 51 52)
                (orfeus/gui::preview-neighborhood-indices 100 50 2))
         "Preview neighborhood omitted nearby photos")
  (check (equal '(97 98 99)
                (orfeus/gui::preview-neighborhood-indices 100 99 2))
         "Preview neighborhood crossed the project end")
  (check (null (orfeus/gui::preview-neighborhood-indices 0 0 2))
...
(defun run-tests ()
  ...
  (test-preview-neighborhood-bounds)
