;; Agfalike E: the whole look for Orfeus's gallery, written by
;; scripts/lightroom-preset-lut.lisp from the Lightroom preset "JSZ-CEDAR E".
(:orfeus-still 1
 (:name "Agfalike E" :graph
  (:nodes
   ((:id 1 :kind :optics :inputs (0) :params
    ...
    (:id 5 :kind :film :inputs (4) :params
     (:lut-path "luts/Agfalike E.cube" :lut-strength 1.0 :grain-amount 0.0
      :grain-size 1.0)))
   :output 5)))
