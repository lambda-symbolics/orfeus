;; Agfalike B: the whole look for Orfeus's gallery, written by
;; scripts/lightroom-preset-lut.lisp from the Lightroom preset "JSZ-CEDAR B".
(:orfeus-still 1
 (:name "Agfalike B" :graph
  (:nodes
   ((:id 1 :kind :optics :inputs (0) :params
    ...
    (:id 6 :kind :film :inputs (5) :params
     (:lut-path "luts/Agfalike B.cube" :lut-strength 1.0 :grain-amount 0.09
      :grain-size 1.0)))
   :output 6)))
