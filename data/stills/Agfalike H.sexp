;; Agfalike H: the whole look for Orfeus's gallery, written by
;; scripts/lightroom-preset-lut.lisp from the Lightroom preset "JSZ-CEDAR H".
(:orfeus-still 1
 (:name "Agfalike H" :graph
  (:nodes
   ((:id 1 :kind :optics :inputs (0) :params
    ...
    (:id 4 :kind :clarity :inputs (3) :params (:amount 0.1 :radius 150.0))
    (:id 5 :kind :film :inputs (4) :params
     (:lut-path "luts/Agfalike H.cube" :lut-strength 1.0 :grain-amount 0.0
      :grain-size 1.0)))
   :output 5)))
