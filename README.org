...
The flake provides SBCL, Rust, Lensfun and the other native dependencies,
...
plus Kodachrome 25, 64, 64 Generic, and 200, and the eight Agfalike looks, baked
from the JSZ CEDAR Lightroom presets by =scripts/lightroom-preset-lut.lisp=. Their pinned
provenance, checksums, and license notice are recorded in =THIRD-PARTY.md=. CUBE
files dropped into =~/.local/share/orfeus/luts/= appear in the Film panel too.
